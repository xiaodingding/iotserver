...
class TestManagementCommand(InterceptStdoutMixin, TestCase):
    fixtures = ['backend/test_dsmrreading.json']
    #
    ...
    #     self._intercept_command_stdout('backend_delete_aggregated_data', consumption=True)
    #     self.assertFalse(statistics_mock.called)
    ...
    #     self.assertFalse(consumption_mock.called)
    #     self.assertTrue(DsmrReading.objects.processed().exists())
    #     self._intercept_command_stdout('backend_delete_aggregated_data', statistics=True)
    ...
    #     self.assertFalse(consumption_mock.called)
    #     self.assertTrue(DsmrReading.objects.processed().exists())
    #     self._intercept_command_stdout('backend_delete_aggregated_data', readings=True)
    #     self.assertFalse(statistics_mock.called)
    #     self.assertFalse(consumption_mock.called)
